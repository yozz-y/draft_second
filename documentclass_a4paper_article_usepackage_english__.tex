...
(PDB entry : 1SA0), chosen for the highest identity (cf table x), most recent reviewed, more complete
...
for the \beta1 and \beta3 subunits respectively. After the modelisation of each part independently, we reassembled them
